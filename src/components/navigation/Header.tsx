    ...
    return (
        <>
            <header className="w-full bg-black sticky top-0 z-30 border-b border-zinc-800">
                ...
                <div className="flex items-center w-full px-4 md:px-8 py-3 gap-3">
                ...
                <div className="flex xl:hidden items-center justify-between px-4 md:px-8 py-2 border-t border-zinc-800">
                    <Link href="/" className="flex items-center">
                        {siteLogoUrl ? (
                            <Image src={siteLogoUrl} alt="Athletica" width={120} height={120} className="w-[120px] h-auto" />
                        ) : (
                            <>
                ...
                <div className="hidden xl:flex items-center px-8 py-3 border-t border-zinc-800 relative">
