...
import { SystemHealthInteractionLayer } from "./SystemHealthInteractionLayer";
import { SystemHealthPresentation } from "./SystemHealthPresentation";
import type { AdminProfile } from "./use-system-health";
    ...
    return (
        <InteractionProvider>
            ...
            <div className="min-h-screen ml-0 max-[1100px]:min-[761px]:ml-16 min-[1101px]:ml-64 max-[760px]:pt-14">
                <SystemHealthInteractionLayer profile={profile} onNavigate={onNavigate} onSignOut={onSignOut}>
                    <SystemHealthPresentation />
                </SystemHealthInteractionLayer>
            </div>
        </InteractionProvider>
    );
}